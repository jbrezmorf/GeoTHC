...
Zde $D_m^i$ \units{}{2}{-1} je koeficient molekulární difúze of the $i$-té látky%
% (obvyklá hodnota v čisté vodě je řádově $10^{-9}$), $\tau=\th^{1/3}$ je tortuozita (viz \cite{millington_quirk}), $\alpha_L^i$ \units{}{1}{} a $\alpha_T^i$ \units{}{1}{} je podélná, resp. příčná disperzivita
.
